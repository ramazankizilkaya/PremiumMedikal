...
namespace MedikalMarket.UI.Areas.Admin.Dtos
{
    public class AdminCreateProductDto
    {
        ...
        [Remote("ValidateProductNameTR", "Product", HttpMethod = "Post", ErrorMessage = "Girmiş olduğunuz Türkçe ürün adı sistemimizde kayıtlıdır.")]
        public string NameTR { get; set; }

        [Required(ErrorMessage = "Lütfen İngilizce ürün adını giriniz.")]
        [Remote("ValidateProductNameEN", "Product", HttpMethod = "Post", ErrorMessage = "Girmiş olduğunuz İngilizce ürün adı sistemimizde kayıtlıdır.")]
        public string NameEN { get; set; }

        [Required(ErrorMessage = "Lütfen Rusça ürün adını giriniz.")]
        [Remote("ValidateProductNameRU", "Product", HttpMethod = "Post", ErrorMessage = "Girmiş olduğunuz Rusça ürün adı sistemimizde kayıtlıdır.")]
        ...
        [Required(ErrorMessage = "Lütfen vitrin fotoğrafı seçiniz seçiniz.")]
        public IFormFile MainPhoto { get; set; }

        [Required(ErrorMessage = "Lütfen ürün detay sayfası için fotoğraf seçiniz.")]
